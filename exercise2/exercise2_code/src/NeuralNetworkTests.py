...
class TestNeuralNetwork2(unittest.TestCase):
    ...
    def test_iris_data(self):
        ...
        with open(self.log, 'a') as f:
            print('On the Iris dataset, we achieve an accuracy of: ' + str(accuracy * 100) + '%', f)
    ...
    def test_digit_data(self):
        ...
        accuracy = Helpers.calculate_accuracy(results, labels)
        with open(self.log, 'a') as f:
            print('On the UCI ML hand-written digits dataset, we achieve an accuracy of: ' + str(accuracy * 100) + '%', f)
